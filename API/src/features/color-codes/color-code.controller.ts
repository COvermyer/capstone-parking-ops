 ...
 */
export const getColorCodes: RequestHandler = asyncHandler(async (req, res) => {
 ...
 * @param res Response Body
 */
export const getColorCodeById: RequestHandler = asyncHandler(async (req, res) => {
 ...
 * @param res Response Body
 */
export const getColorCodeByName: RequestHandler = asyncHandler(async (req, res) => {
